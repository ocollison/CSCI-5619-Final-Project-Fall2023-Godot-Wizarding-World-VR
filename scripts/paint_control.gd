...
func _process(_delta):
	...
	if Input.is_mouse_button_pressed(MOUSE_BUTTON_LEFT) or StateManager.drawing == true:
		...
		if check_if_mouse_is_inside_canvas() or StateManager.drawing == true:
...
func save_picture(path):
	...
	var name = "Mesh" + str(StateManager.num)
	StateManager.num += 1
...
func _on_cast_spell_pressed():
	...
	var path = "C:/Users/student/Documents/GitHub/CSCI-5619-Final-Project-Fall2023-main/images/" + str(name) + ".png"
	save_picture(path)
